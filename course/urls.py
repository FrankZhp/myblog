...
from .views import CourseListView, AboutView, \
                   ManageCourseListView, CreateCourseView, \
                   DeleteCourseView, CreateLessonView, \
                   ListLessonsView, StudentListLessonView
...
urlpatterns = [
    ...
    path('lessons-list/<int:course_id>', StudentListLessonView.as_view(), name="lesson_list"),
]
